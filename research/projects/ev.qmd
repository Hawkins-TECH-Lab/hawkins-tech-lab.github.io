...
The second Sankey plot shows the relationship between current vehicle ownership and the expected next vehicle purchase. Interestingly, here we see a larger share of people selecting BEV options than in our experiment.
```{python}
