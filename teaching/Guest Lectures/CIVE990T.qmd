---
title: "Introduction to Land Use Modeling"
subtitle: "CIVE 990T - Fall 2023"
editor: visual
format: 
  revealjs: 
    theme: simple
...
- Bourne (1982) defines **urban structure** as combination of:
  ...
  - **Organizing principles** - reltaionshihps between urban form & interactions such as travel cost, social status, segregation
...
- Lowry model (1964)
- DRAM/EMPAL (1967)
- TRANUS & MEPLAN (South America & Europe)
