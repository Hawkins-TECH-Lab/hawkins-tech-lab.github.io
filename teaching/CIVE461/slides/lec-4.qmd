---
title: "Lecture 4 - Transportation Planning Process"
...
## Strategies (for Planners) to Overcome Institutional Barriers
::: incremental
...
::: columns
::: {.column width="75%"}
![](../images/lecture4/incremental_model.png){fig-align="center"  width=60%}
:::
::: {.column width="25%"}
**Problems:**
...
![](../images/lecture4/transport_policy_blocks.png){fig-align="center"}