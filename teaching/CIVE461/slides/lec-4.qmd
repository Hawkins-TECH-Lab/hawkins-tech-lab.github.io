---
title: "Lecture 4 - Trip Generation"
...
![](../images/lecture4/omaha_taz.png){.absolute top="225" right="0" width=25%}
</br></br></br></br>

2. Trip frequency choice by households (method: **discrete choice**)
![](../images/lecture4/van.png){.absolute bottom="0" left="500" width=25%}
:::
...
![](../images/lecture4/model_process.png){fig-align="center"}

## Classic 4-Step Travel Model
![](../images/lecture4/4_step_model.png){fig-align="center"}
...
- For example, when faced with increased congestion a trip maker can respond with a range of simple changes to:
  ...
  - **Trip frequency** by undertaking the trip at another day, perhaps combining it with other activities
...
![](../images/lecture4/trip_production_attraction.png){fig-align="center"}

## Trip Production & Attraction
![](../images/lecture4/trip_production_1.png){fig-align="left" width=45%}
![](../images/lecture4/trip_production_2.png){fig-align="right" width=45%}
...
![](../images/lecture4/trip_production_3.png){.absolute bottom="0" left="300" width=30%}
...
![](../images/lecture4/ite_trip_generation.png){.absolute bottom="0" right="0" width=25%}
...
## Cross-Classification Models
![](../images/lecture4/cross_classification.png){fig-align="center"}
...
![](../images/lecture4/zone_regression_table.png){fig-align="center"}
...
![](../images/lecture4/histogram_residuals.png){fig-align="center"}

## Residuals Vs. Explanatory Variables
![](../images/lecture4/residuals_variance.png){fig-align="center"}

## Example {.smaller}
::: columns
::: {.column width="25%"}
![](../images/lecture4/residuals_example.png){fig-align="center"}
:::
::: {.column }
...
![](../images/lecture4/residuals_results_1.png){.absolute bottom="0" left="0"}
![](../images/lecture4/residuals_plot.png){.absolute top="200" right="0" width=45%}

## Analysis of Residuals Vs. X {.smaller}
- Looks like a constant variance across values of $X$...
![](../images/lecture4/residuals_x_plot.png){fig-align="center"}
...
![](../images/lecture4/residuals_z_plot.png){fig-align="center"}
...
![](../images/lecture4/residuals_results_2.png){.absolute bottom="0" left="0"}

## Analysis of Residuals Vs. X & Z$ {.smaller}
- Now residuals don’t change over different values of X or Z!
![](../images/lecture4/residuals_x_z_1.png){fig-align="center" width=50%}
![](../images/lecture4/residuals_x_z_2.png){fig-align="center" width=40%}

## Dealing With Non-Linear Relationships
![](../images/lecture4/non_linear_plot_1.png){.absolute bottom="150" left="0" width=60%}
![](../images/lecture4/non_linear_table_1.png){.absolute bottom="0" right="0" width=25%}

## Transform the Explanatory Variable (add $x^2$ term)
![](../images/lecture4/non_linear_plot_2.png){.absolute bottom="100" left="0" width=60%}
![](../images/lecture4/non_linear_table_2.png){.absolute bottom="50" right="0" width=25%}
...
![](../images/lecture4/non_linear_table_3.png){fig-align="right"}
...
![](../images/lecture4/validation_table.png){fig-align="center" width=40%}
...
- Accessibility generally defined by $A_i = \sum_j f(E_j, C_{ij}$ 𝐴_𝑖=∑_𝑗▒𝑓(𝐸_𝑗,𝐶_{𝑖𝑗}) where $E_j$ is an attraction measure for zone $j$ &  $C_{ij}$ is a **generalized cost of travel** between zones $i$ & $j$.
