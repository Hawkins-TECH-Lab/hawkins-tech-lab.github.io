...
$$\ln(V) = \alpha_0 + \sum_j \alpha_j \ln(p_j) + \frac{1}{2}\sum_j\sum_k \gamma_{jk} \ln(p_j) \ln(p_k) + \beta_o \prod_j p_j^{\beta_j}$$
...
Why is it impossible to derive demand functions directly?
