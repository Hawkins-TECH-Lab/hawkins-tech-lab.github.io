---
title: "Lecture 8 - Advanced Choice Models"
...
![](../images/lecture7/aon_1.png){.absolute top="75" right="0" width="40%"} ![](../images/lecture7/aon_2.png){.absolute top="325" right="0" width="40%"} ![](../images/lecture7/aon_3.png){.absolute bottom="0" right="100" width="40%"}
...
Must determine link flows {V1, V2} such that $$𝑉_1+𝑉_2=𝑉_𝐴𝐵$$ $$𝑡_1=𝑡_2=𝑡^∗$$ Where $t^*$ is the equilibrium travel time between A & B
...
-   Here, optimum is area under $f_2(v_2)$ ![](../images/lecture7/eqn_soln_3.png){.absolute bottom="0" right="200" width="50%"}
...
-   F(V) given by $$min \sum_l \int_0^{v_l}f_l(v) d(v)  \text{   (𝐸𝑄1)}$$
