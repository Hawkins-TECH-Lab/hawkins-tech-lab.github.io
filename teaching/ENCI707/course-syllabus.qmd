...
|           | Day       | Time              | Location                       |
|-----------|-----------|-------------------|--------------------------------|
| Lectures  | Mon/Wed | 1:30 pm - 2:45 pm | PKI 164 (Omaha)      |
| Office hours  | Wed | 1:30 pm - 2:45 pm | ENF284      |
...
Dr. Jason Hawkins \
ENF284 \
402-472-0529 | Email me through the course D2L messenger system
...
Parts of some lectures will be dedicated to working on Application Exercises (AEs). These exercises which give you an opportunity to practice applying the transportation planning concepts and code introduced in the readings and lectures. These AEs are due within two days of the corresponding lecture period. Specifically, AEs from Monday lectures are due Wednesday by 11:59 pm CT, and AEs from Wednesday lectures are due Friday by 11:59 pm CT. These exercises are marked as complete/incomplete.

### Pre-lecture quizzes

Prior to most lectures, you will be asked to complete a set of readings and/or videos. A quiz is associated with each of these pre-lecture activities. You must complete the quiz prior to lecture. These quiizes are marked as complete/incomplete, with the objective of ensuring you arrive at lecture prepared with questions.
